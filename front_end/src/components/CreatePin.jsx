    ...
    <div className = "flex flex-col items-center justify-center mt-5  lg: h-4/5">
      ...
      <div className = "flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        ...
        {/*Title*/}
          ...
          placeholder = "Add your Title" className = ' text-2xl sm:text-3xl font-bold border-b-2 border-gray-200 p-2' />
        ...
        {/*user (if exists)*/}
          ...
          {user && (
            <div className = 'flex gap-2 my-2 items-center bg-white rounded-lg'>
              ...
              <img src ={user.image} className = "rounded-full w-10 h-10" alt = "user-profile"/>
        ...
        <input type = "text" value = {about} onChange ={(e)=>setAbout(e.target.value)}
          placeholder = "What is your Pin about" className = ' text-base sm:text-lg border-b-2 border-gray-200 p-2' />


        <input type = "text" value = {destination} onChange ={(e)=>setDestination(e.target.value)}
          placeholder = "Add a destination link" className = ' text-base sm:text-lg border-b-2 border-gray-200 p-2' />

        {/*Categories*/}

          <div className = 'flex flex-col '>
              <div>
                <p className = 'mb-2 font-semibold text-lg sm:text-xl'>Choose Pin categories</p>
